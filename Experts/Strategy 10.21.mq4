...
//|    Generated at Wed Jan 24 08:18:00 GMT 2018
//|                                                          
...
extern string CustomComment = "Strategy 10.21";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: (ATR(83) Crosses Above ATR(43))
      if(TradeLong) {
         bool LongEntryCondition = ((iATR(NULL, 0, 83, 2) < iATR(NULL, 0, 43, 2)) && (iATR(NULL, 0, 83, 1) > iATR(NULL, 0, 43, 1)));
         if(LongEntryCondition == true) {
            openPosition(1);
         }
      }
   
      // SHORT: (ATR(83) Crosses Below ATR(43))
      if(TradeShort) {
         bool ShortEntryCondition = ((iATR(NULL, 0, 83, 2) > iATR(NULL, 0, 43, 2)) && (iATR(NULL, 0, 83, 1) < iATR(NULL, 0, 43, 1)));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 10.21", 9, "Tahoma", LabelColor);
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(241 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(241 * gPointCoef));
   }
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((3.05 * iATR(NULL, 0, 38, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((3.05 * iATR(NULL, 0, 38, 1))));
   }
