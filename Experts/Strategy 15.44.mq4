...
//|    Generated at Fri Jan 26 11:45:00 GMT 2018
//|                                                          
...
extern string CustomComment = "Strategy 15.44";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: (((TEMA(94) - SMA(24)) - ATR(44)) < ATR(79))
      if(TradeLong) {
         bool LongEntryCondition = (((iCustom(NULL,0, "TEMA", 94, 0, 1) - iMA(NULL, 0, 24, 0, MODE_SMA, PRICE_CLOSE, 1)) - iATR(NULL, 0, 44, 1)) < iATR(NULL, 0, 79, 1));
         if(LongEntryCondition == true) {
            openPosition(1);
         }
      }
   
      // SHORT: (((TEMA(94) - SMA(24)) - ATR(44)) > ATR(79))
      if(TradeShort) {
         bool ShortEntryCondition = (((iCustom(NULL,0, "TEMA", 94, 0, 1) - iMA(NULL, 0, 24, 0, MODE_SMA, PRICE_CLOSE, 1)) - iATR(NULL, 0, 44, 1)) > iATR(NULL, 0, 79, 1));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 15.44", 9, "Tahoma", LabelColor);
