...
extern string CustomComment = "Strategy 5.27";
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 5.27", 9, "Tahoma", LabelColor);
...
double getTradeOpenPrice(int tradeDirection) {
   ...
   if(tradeDirection == 1) {
      // long
         return(getHighest(89, 1) + (0.4) * (gbTrueRange(5, 1)));
   } else {
      // short
      return(getLowest(89, 1) + (-0.4) * (gbTrueRange(5, 1)));
   }
}
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((1.1 * iATR(NULL, 0, 99, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((1.1 * iATR(NULL, 0, 99, 1))));
   }
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(187 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(187 * gPointCoef));
   }
