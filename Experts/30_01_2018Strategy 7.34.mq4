...
extern string CustomComment = "Strategy 7.34";
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 7.34", 9, "Tahoma", LabelColor);
...
double getStopTrailingByClose() {
   double value = 0;
   if (OrderType() == OP_BUY) {
      value = iMA(NULL, 0, 40, 0, MODE_EMA, PRICE_CLOSE, 1) + (0.1) * (iCustom(NULL, 0, "BBandWidthRatio", 86, 2.0, 0, 1));
