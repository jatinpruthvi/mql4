...
//|    Generated at Tue Jan 23 14:46:00 GMT 2018
//|                                                          
//|    Tested on EURUSD_dks, H1, 02.01.2017 - 31.01.2017
...
extern string CustomComment = "Strategy 6.26";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: ((SMA(23) - EMA(97)) < ATR(76))
      if(TradeLong) {
         bool LongEntryCondition = ((iMA(NULL, 0, 23, 0, MODE_SMA, PRICE_CLOSE, 1) - iMA(NULL, 0, 97, 0, MODE_EMA, PRICE_CLOSE, 1)) < iATR(NULL, 0, 76, 1));
         if(LongEntryCondition == true) {
            openPosition(1);
         }
      }
   
      // SHORT: ((SMA(23) - EMA(97)) > ATR(76))
      if(TradeShort) {
         bool ShortEntryCondition = ((iMA(NULL, 0, 23, 0, MODE_SMA, PRICE_CLOSE, 1) - iMA(NULL, 0, 97, 0, MODE_EMA, PRICE_CLOSE, 1)) > iATR(NULL, 0, 76, 1));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 6.26", 9, "Tahoma", LabelColor);
