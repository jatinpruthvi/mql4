...
extern string CustomComment = "Strategy 23.38";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: (ATR(6) < ATR(69))
      if(TradeLong) {
         bool LongEntryCondition = (iATR(NULL, 0, 6, 1) < iATR(NULL, 0, 69, 1));
      ...
      // SHORT: (ATR(6) > ATR(69))
      if(TradeShort) {
         bool ShortEntryCondition = (iATR(NULL, 0, 6, 1) > iATR(NULL, 0, 69, 1));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 23.38", 9, "Tahoma", LabelColor);
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((3.63 * iATR(NULL, 0, 39, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((3.63 * iATR(NULL, 0, 39, 1))));
   }
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((3.63 * iATR(NULL, 0, 29, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((3.63 * iATR(NULL, 0, 29, 1))));
   }
