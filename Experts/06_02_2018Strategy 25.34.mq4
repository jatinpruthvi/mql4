...
//|    Generated at Tue Feb 06 07:58:00 GMT 2018
//|                                                          
//|    Tested on EURAUD, M15, 16.11.2017 - 01.02.2018
...
extern bool ExitAtEndOfDay = true;
...
extern string CustomComment = "Strategy 25.34";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: (((((ATR(97) < ATR(62)) Or (((WMA(10) < SMA(34)) Or (BollingerBand_Range(13, 2, 0) < ATR(61))) And ((WMA(3) < SMA(61)) And (ATR(41) < ATR(97))))) And (ATR(16) < ATR(97))) Or (((((WMA(10) < SMA(34)) Or (BollingerBand_Range(13, 2, 0) < ATR(61))) And (ATR(25) < ATR(97))) Or (ATR(80) < ATR(62))) And (ATR(29) < ATR(80)))) And (ATR(3) < ATR(62)))
      if(TradeLong) {
         bool LongEntryCondition = (((((iATR(NULL, 0, 97, 1) < iATR(NULL, 0, 62, 1)) || (((iMA(NULL, 0, 10, 0, MODE_LWMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 34, 0, MODE_SMA, PRICE_CLOSE, 1)) || ((iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_UPPER, 1) - iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_LOWER, 1)) < iATR(NULL, 0, 61, 1))) && ((iMA(NULL, 0, 3, 0, MODE_LWMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 61, 0, MODE_SMA, PRICE_CLOSE, 1)) && (iATR(NULL, 0, 41, 1) < iATR(NULL, 0, 97, 1))))) && (iATR(NULL, 0, 16, 1) < iATR(NULL, 0, 97, 1))) || (((((iMA(NULL, 0, 10, 0, MODE_LWMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 34, 0, MODE_SMA, PRICE_CLOSE, 1)) || ((iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_UPPER, 1) - iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_LOWER, 1)) < iATR(NULL, 0, 61, 1))) && (iATR(NULL, 0, 25, 1) < iATR(NULL, 0, 97, 1))) || (iATR(NULL, 0, 80, 1) < iATR(NULL, 0, 62, 1))) && (iATR(NULL, 0, 29, 1) < iATR(NULL, 0, 80, 1)))) && (iATR(NULL, 0, 3, 1) < iATR(NULL, 0, 62, 1)));
         if(LongEntryCondition == true) {
            openPosition(1);
         }
      }
   
      // SHORT: (((((ATR(97) > ATR(62)) Or (((WMA(10) > SMA(34)) Or (BollingerBand_Range(13, 2, 0) > ATR(61))) And ((WMA(3) > SMA(61)) And (ATR(41) > ATR(97))))) And (ATR(16) > ATR(97))) Or (((((WMA(10) > SMA(34)) Or (BollingerBand_Range(13, 2, 0) > ATR(61))) And (ATR(25) > ATR(97))) Or (ATR(80) > ATR(62))) And (ATR(29) > ATR(80)))) And (ATR(3) > ATR(62)))
      if(TradeShort) {
         bool ShortEntryCondition = (((((iATR(NULL, 0, 97, 1) > iATR(NULL, 0, 62, 1)) || (((iMA(NULL, 0, 10, 0, MODE_LWMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 34, 0, MODE_SMA, PRICE_CLOSE, 1)) || ((iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_UPPER, 1) - iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_LOWER, 1)) > iATR(NULL, 0, 61, 1))) && ((iMA(NULL, 0, 3, 0, MODE_LWMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 61, 0, MODE_SMA, PRICE_CLOSE, 1)) && (iATR(NULL, 0, 41, 1) > iATR(NULL, 0, 97, 1))))) && (iATR(NULL, 0, 16, 1) > iATR(NULL, 0, 97, 1))) || (((((iMA(NULL, 0, 10, 0, MODE_LWMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 34, 0, MODE_SMA, PRICE_CLOSE, 1)) || ((iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_UPPER, 1) - iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_LOWER, 1)) > iATR(NULL, 0, 61, 1))) && (iATR(NULL, 0, 25, 1) > iATR(NULL, 0, 97, 1))) || (iATR(NULL, 0, 80, 1) > iATR(NULL, 0, 62, 1))) && (iATR(NULL, 0, 29, 1) > iATR(NULL, 0, 80, 1)))) && (iATR(NULL, 0, 3, 1) > iATR(NULL, 0, 62, 1)));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 25.34", 9, "Tahoma", LabelColor);
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((4.36 * iATR(NULL, 0, 62, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((4.36 * iATR(NULL, 0, 62, 1))));
   }
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((1.66 * iATR(NULL, 0, 16, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((1.66 * iATR(NULL, 0, 16, 1))));
   }
