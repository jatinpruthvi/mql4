...
//|    Generated at Thu Jan 25 09:11:00 GMT 2018
//|                                                          
//|    Tested on EURUSD_dks, M5, 02.01.2016 - 31.01.2017
//|    Spread: 2.0, Slippage: 2.0, Min distance of stop from price: 5.0
//+------------------------------------------------------------------+
...
extern int MaxTradesPerDay = 5; // 0 means unlimited
extern bool LimitSignalsToRange = false;
extern string TimeRangeFrom = "09:00";
extern string TimeRangeTo = "16:00";
extern bool ExitAtEndOfRange = true;
...
extern string CustomComment = "Strategy 50.20";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: ((((((ATR(77) Crosses Above ATR(72)) Or (EMA(77) Crosses Below EMA(44))) Or (ATR(77) Crosses Above ATR(44))) Or (EMA(72) Crosses Below EMA(44))) Or (EMA(85) Crosses Below EMA(37))) Or ((((EMA(85) Crosses Below EMA(37)) Or ((ATR(77) Crosses Above ATR(44)) Or (EMA(85) Crosses Below EMA(44)))) Or (ATR(77) Crosses Above ATR(72))) Or (ATR(85) Crosses Above ATR(44))))
      if(TradeLong) {
         bool LongEntryCondition = (((((((iATR(NULL, 0, 77, 2) < iATR(NULL, 0, 72, 2)) && (iATR(NULL, 0, 77, 1) > iATR(NULL, 0, 72, 1))) || ((iMA(NULL, 0, 77, 0, MODE_EMA, PRICE_CLOSE, 2) > iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 77, 0, MODE_EMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 1)))) || ((iATR(NULL, 0, 77, 2) < iATR(NULL, 0, 44, 2)) && (iATR(NULL, 0, 77, 1) > iATR(NULL, 0, 44, 1)))) || ((iMA(NULL, 0, 72, 0, MODE_EMA, PRICE_CLOSE, 2) > iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 72, 0, MODE_EMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 1)))) || ((iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 2) > iMA(NULL, 0, 37, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 37, 0, MODE_EMA, PRICE_CLOSE, 1)))) || (((((iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 2) > iMA(NULL, 0, 37, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 37, 0, MODE_EMA, PRICE_CLOSE, 1))) || (((iATR(NULL, 0, 77, 2) < iATR(NULL, 0, 44, 2)) && (iATR(NULL, 0, 77, 1) > iATR(NULL, 0, 44, 1))) || ((iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 2) > iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 1))))) || ((iATR(NULL, 0, 77, 2) < iATR(NULL, 0, 72, 2)) && (iATR(NULL, 0, 77, 1) > iATR(NULL, 0, 72, 1)))) || ((iATR(NULL, 0, 85, 2) < iATR(NULL, 0, 44, 2)) && (iATR(NULL, 0, 85, 1) > iATR(NULL, 0, 44, 1)))));
         if(LongEntryCondition == true) {
            openPosition(1);
         }
      }
   
      // SHORT: ((((((ATR(77) Crosses Below ATR(72)) Or (EMA(77) Crosses Above EMA(44))) Or (ATR(77) Crosses Below ATR(44))) Or (EMA(72) Crosses Above EMA(44))) Or (EMA(85) Crosses Above EMA(37))) Or ((((EMA(85) Crosses Above EMA(37)) Or ((ATR(77) Crosses Below ATR(44)) Or (EMA(85) Crosses Above EMA(44)))) Or (ATR(77) Crosses Below ATR(72))) Or (ATR(85) Crosses Below ATR(44))))
      if(TradeShort) {
         bool ShortEntryCondition = (((((((iATR(NULL, 0, 77, 2) > iATR(NULL, 0, 72, 2)) && (iATR(NULL, 0, 77, 1) < iATR(NULL, 0, 72, 1))) || ((iMA(NULL, 0, 77, 0, MODE_EMA, PRICE_CLOSE, 2) < iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 77, 0, MODE_EMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 1)))) || ((iATR(NULL, 0, 77, 2) > iATR(NULL, 0, 44, 2)) && (iATR(NULL, 0, 77, 1) < iATR(NULL, 0, 44, 1)))) || ((iMA(NULL, 0, 72, 0, MODE_EMA, PRICE_CLOSE, 2) < iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 72, 0, MODE_EMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 1)))) || ((iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 2) < iMA(NULL, 0, 37, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 37, 0, MODE_EMA, PRICE_CLOSE, 1)))) || (((((iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 2) < iMA(NULL, 0, 37, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 37, 0, MODE_EMA, PRICE_CLOSE, 1))) || (((iATR(NULL, 0, 77, 2) > iATR(NULL, 0, 44, 2)) && (iATR(NULL, 0, 77, 1) < iATR(NULL, 0, 44, 1))) || ((iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 2) < iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 85, 0, MODE_EMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 1))))) || ((iATR(NULL, 0, 77, 2) > iATR(NULL, 0, 72, 2)) && (iATR(NULL, 0, 77, 1) < iATR(NULL, 0, 72, 1)))) || ((iATR(NULL, 0, 85, 2) > iATR(NULL, 0, 44, 2)) && (iATR(NULL, 0, 85, 1) < iATR(NULL, 0, 44, 1)))));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 50.20", 9, "Tahoma", LabelColor);
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(157 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(157 * gPointCoef));
   }
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((4.2 * iATR(NULL, 0, 44, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((4.2 * iATR(NULL, 0, 44, 1))));
   }
