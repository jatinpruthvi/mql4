...
extern string CustomComment = "Strategy 19.30";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: (((ATR(84) < ATR(39)) And (SMA(84) Crosses Below TEMA(96))) And (ATR(84) < ATR(37)))
      if(TradeLong) {
         bool LongEntryCondition = (((iATR(NULL, 0, 84, 1) < iATR(NULL, 0, 39, 1)) && ((iMA(NULL, 0, 84, 0, MODE_SMA, PRICE_CLOSE, 2) > iCustom(NULL,0, "TEMA", 96, 0, 2)) && (iMA(NULL, 0, 84, 0, MODE_SMA, PRICE_CLOSE, 1) < iCustom(NULL,0, "TEMA", 96, 0, 1)))) && (iATR(NULL, 0, 84, 1) < iATR(NULL, 0, 37, 1)));
         if(LongEntryCondition == true) {
            openPosition(1);
         }
      }
   
      // SHORT: (((ATR(84) > ATR(39)) And (SMA(84) Crosses Above TEMA(96))) And (ATR(84) > ATR(37)))
      if(TradeShort) {
         bool ShortEntryCondition = (((iATR(NULL, 0, 84, 1) > iATR(NULL, 0, 39, 1)) && ((iMA(NULL, 0, 84, 0, MODE_SMA, PRICE_CLOSE, 2) < iCustom(NULL,0, "TEMA", 96, 0, 2)) && (iMA(NULL, 0, 84, 0, MODE_SMA, PRICE_CLOSE, 1) > iCustom(NULL,0, "TEMA", 96, 0, 1)))) && (iATR(NULL, 0, 84, 1) > iATR(NULL, 0, 37, 1)));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 19.30", 9, "Tahoma", LabelColor);
