...
//|    Generated at Wed Jan 24 11:45:00 GMT 2018
//|                                                          
...
extern string CustomComment = "Strategy 13.11";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: (EMA(30) < SMA(95))
      if(TradeLong) {
         bool LongEntryCondition = (iMA(NULL, 0, 30, 0, MODE_EMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 95, 0, MODE_SMA, PRICE_CLOSE, 1));
      ...
      // SHORT: (EMA(30) > SMA(95))
      if(TradeShort) {
         bool ShortEntryCondition = (iMA(NULL, 0, 30, 0, MODE_EMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 95, 0, MODE_SMA, PRICE_CLOSE, 1));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 13.11", 9, "Tahoma", LabelColor);
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(106 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(106 * gPointCoef));
   }
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((4.93 * iATR(NULL, 0, 31, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((4.93 * iATR(NULL, 0, 31, 1))));
   }
