...
extern string CustomComment = "Strategy 2.36";
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 2.36", 9, "Tahoma", LabelColor);
...
double getTradeOpenPrice(int tradeDirection) {
   ...
   if(tradeDirection == 1) {
      // long
         return(HeikenAshiOpen(5) + (0) * (iATR(NULL, 0, 64, 1)));
   } else {
      // short
      return(HeikenAshiOpen(5) + (0) * (iATR(NULL, 0, 64, 1)));
   }
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((2.9 * iATR(NULL, 0, 93, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((2.9 * iATR(NULL, 0, 93, 1))));
   }
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(277 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(277 * gPointCoef));
   }
