...
//|    Generated at Wed Jan 31 13:49:00 GMT 2018
//|                                                          
//|    Tested on GBPUSD_dks, M15, 02.01.2016 - 31.01.2017
...
extern string CustomComment = "Strategy 1.13";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: (((HeikenAshiOpen(10) + HeikenAshiOpen(8)) < High(14)) And Doji Candle Pattern)
      if(TradeLong) {
         bool LongEntryCondition = (((HeikenAshiOpen(10) + HeikenAshiOpen(8)) < High[14]) && candlePatternDoji(1));
         if(LongEntryCondition == true) {
            openPosition(1);
         }
      }
   
      // SHORT: (((HeikenAshiOpen(10) + HeikenAshiOpen(8)) > Low(14)) And Doji Candle Pattern)
      if(TradeShort) {
         bool ShortEntryCondition = (((HeikenAshiOpen(10) + HeikenAshiOpen(8)) > Low[14]) && candlePatternDoji(1));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 1.13", 9, "Tahoma", LabelColor);
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((3.37 * iATR(NULL, 0, 5, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((3.37 * iATR(NULL, 0, 5, 1))));
   }
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(268 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(268 * gPointCoef));
   }
