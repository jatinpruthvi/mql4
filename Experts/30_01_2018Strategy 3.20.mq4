...
extern string CustomComment = "Strategy 3.20";
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 3.20", 9, "Tahoma", LabelColor);
...
double getTradeOpenPrice(int tradeDirection) {
   ...
   if(tradeDirection == 1) {
      // long
         return(getHighest(82, 1) + (0) * (gbBarRange(11, 1)));
   } else {
      // short
      return(getLowest(82, 1) + (0) * (gbBarRange(11, 1)));
   }
}
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(266 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(266 * gPointCoef));
   }
