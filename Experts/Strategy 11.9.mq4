...
//|    Generated at Tue Jan 23 16:30:00 GMT 2018
//|                                                          
...
extern string CustomComment = "Strategy 11.9";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: (EMA(84) > SMA(39))
      if(TradeLong) {
         bool LongEntryCondition = (iMA(NULL, 0, 84, 0, MODE_EMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 39, 0, MODE_SMA, PRICE_CLOSE, 1));
      ...
      // SHORT: (EMA(84) < SMA(39))
      if(TradeShort) {
         bool ShortEntryCondition = (iMA(NULL, 0, 84, 0, MODE_EMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 39, 0, MODE_SMA, PRICE_CLOSE, 1));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 11.9", 9, "Tahoma", LabelColor);
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((3.11 * iATR(NULL, 0, 38, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((3.11 * iATR(NULL, 0, 38, 1))));
   }
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(131 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(131 * gPointCoef));
   }
