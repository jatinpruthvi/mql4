...
#property copyright "StrategyQuant.com volk"
...
extern string CustomComment = "Strategy 42.31";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: ((((ATR(77) Crosses Above ATR(72)) Or ((ATR(77) Crosses Above ATR(72)) Or ((ATR(77) Crosses Above ATR(44)) Or (EMA(72) Crosses Below EMA(44))))) Or (SMA(85) Crosses Below EMA(37))) Or (ATR(77) Crosses Above ATR(72)))
      if(TradeLong) {
         bool LongEntryCondition = (((((iATR(NULL, 0, 77, 2) < iATR(NULL, 0, 72, 2)) && (iATR(NULL, 0, 77, 1) > iATR(NULL, 0, 72, 1))) || (((iATR(NULL, 0, 77, 2) < iATR(NULL, 0, 72, 2)) && (iATR(NULL, 0, 77, 1) > iATR(NULL, 0, 72, 1))) || (((iATR(NULL, 0, 77, 2) < iATR(NULL, 0, 44, 2)) && (iATR(NULL, 0, 77, 1) > iATR(NULL, 0, 44, 1))) || ((iMA(NULL, 0, 72, 0, MODE_EMA, PRICE_CLOSE, 2) > iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 72, 0, MODE_EMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 44, 0, MODE_EMA, PRICE_CLOSE, 1)))))) || ((iMA(NULL, 0, 85, 0, MODE_SMA, PRICE_CLOSE, 2) > iMA(NULL, 0, 37, 0, MODE_EMA, PRICE_CLOSE, 2)) && (iMA(NULL, 0, 85, 0, MODE_SMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 37, 0, MODE_EMA, PRICE_CLOSE, 1)))) || ((iATR(NULL, 0, 77, 2) < iATR(NULL, 0, 72, 2)) && (iATR(NULL, 0, 77, 1) > iATR(NULL, 0, 72, 1))));
         if(LongEntryCondition == true) {
            openPosition(1);
         }
      }
   
      // SHORT: ((((ATR(77) Crosses Below ATR(72)) Or ((ATR(77) Crosses Below ATR(72)) Or ((ATR(77) Crosses Below ATR(44)) Or (EMA(72) Crosses Above EMA(44))))) Or (SMA(85) Crosses Above EMA(37))) Or (ATR(77) Crosses Below ATR(72)))
      if(TradeShort) {
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 42.31", 9, "Tahoma", LabelColor);
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(2 * iATR(NULL, 0, 44, 1)));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(2 * iATR(NULL, 0, 44, 1)));
   }
