...
double getTradeOpenPrice(int tradeDirection) {
   ...
   if(tradeDirection == 1) {
      // long
         return(getHighest(89, 1) + (0.4) * (gbBarRange(41, 1)));
   } else {
      // short
      return(getLowest(89, 1) + (-0.4) * (gbBarRange(41, 1)));
   }
}
...
double getStopLoss(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(172 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(172 * gPointCoef));
   }
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT(259 * gPointCoef));
   } else {
      // short
      return(checkCorrectMinMaxSLPT(259 * gPointCoef));
   }
...
double getStopTrailingByClose() {
   double value = 0;
   if (OrderType() == OP_BUY) {
      value = iCustom(NULL, 0, "LinReg", 2, 0, 1) + (0.5) * (gbTrueRange(95, 1));
