...
extern string CustomComment = "Strategy 8.21";
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 8.21", 9, "Tahoma", LabelColor);
...
double getTradeOpenPrice(int tradeDirection) {
   ...
   if(tradeDirection == 1) {
      // long
         return(iIchimoku(NULL, 0, 6, 18, 38, MODE_KIJUNSEN, 1) + (0.6) * (iCustom(NULL, 0, "BBandWidthRatio", 9, 2.0, 0, 1)));
   } else {
      // short
      return(iIchimoku(NULL, 0, 6, 18, 38, MODE_KIJUNSEN, 1) + (-0.6) * (iCustom(NULL, 0, "BBandWidthRatio", 9, 2.0, 0, 1)));
   }
