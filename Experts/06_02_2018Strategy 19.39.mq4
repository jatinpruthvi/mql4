...
extern string CustomComment = "Strategy 19.39";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: (((((((WMA(10) < SMA(34)) Or (BollingerBand_Range(13, 2, 0) < ATR(61))) And ((EMA(25) < SMA(61)) And (ATR(3) < ATR(97)))) Or (ATR(80) < ATR(62))) And (ATR(29) < ATR(97))) Or (ATR(3) > BollingerBand_Range(21, 6, 0))) And (ATR(16) < ATR(97)))
      if(TradeLong) {
         bool LongEntryCondition = (((((((iMA(NULL, 0, 10, 0, MODE_LWMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 34, 0, MODE_SMA, PRICE_CLOSE, 1)) || ((iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_UPPER, 1) - iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_LOWER, 1)) < iATR(NULL, 0, 61, 1))) && ((iMA(NULL, 0, 25, 0, MODE_EMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 61, 0, MODE_SMA, PRICE_CLOSE, 1)) && (iATR(NULL, 0, 3, 1) < iATR(NULL, 0, 97, 1)))) || (iATR(NULL, 0, 80, 1) < iATR(NULL, 0, 62, 1))) && (iATR(NULL, 0, 29, 1) < iATR(NULL, 0, 97, 1))) || (iATR(NULL, 0, 3, 1) > (iBands(NULL, 0, 21, 6, 0, PRICE_CLOSE, MODE_UPPER, 1) - iBands(NULL, 0, 21, 6, 0, PRICE_CLOSE, MODE_LOWER, 1)))) && (iATR(NULL, 0, 16, 1) < iATR(NULL, 0, 97, 1)));
         if(LongEntryCondition == true) {
            openPosition(1);
         }
      }
   
      // SHORT: (((((((WMA(10) > SMA(34)) Or (BollingerBand_Range(13, 2, 0) > ATR(61))) And ((EMA(25) > SMA(61)) And (ATR(3) > ATR(97)))) Or (ATR(80) > ATR(62))) And (ATR(29) > ATR(97))) Or (ATR(3) < BollingerBand_Range(21, 6, 0))) And (ATR(16) > ATR(97)))
      if(TradeShort) {
         bool ShortEntryCondition = (((((((iMA(NULL, 0, 10, 0, MODE_LWMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 34, 0, MODE_SMA, PRICE_CLOSE, 1)) || ((iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_UPPER, 1) - iBands(NULL, 0, 13, 2, 0, PRICE_CLOSE, MODE_LOWER, 1)) > iATR(NULL, 0, 61, 1))) && ((iMA(NULL, 0, 25, 0, MODE_EMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 61, 0, MODE_SMA, PRICE_CLOSE, 1)) && (iATR(NULL, 0, 3, 1) > iATR(NULL, 0, 97, 1)))) || (iATR(NULL, 0, 80, 1) > iATR(NULL, 0, 62, 1))) && (iATR(NULL, 0, 29, 1) > iATR(NULL, 0, 97, 1))) || (iATR(NULL, 0, 3, 1) < (iBands(NULL, 0, 21, 6, 0, PRICE_CLOSE, MODE_UPPER, 1) - iBands(NULL, 0, 21, 6, 0, PRICE_CLOSE, MODE_LOWER, 1)))) && (iATR(NULL, 0, 16, 1) > iATR(NULL, 0, 97, 1)));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 19.39", 9, "Tahoma", LabelColor);
...
double getProfitTarget(int tradeDirection) {
   if(tradeDirection == 1) {
      // long
      return(checkCorrectMinMaxSLPT((1.66 * iATR(NULL, 0, 34, 1))));
   } else {
      // short
      return(checkCorrectMinMaxSLPT((1.66 * iATR(NULL, 0, 34, 1))));
   }
