...
//|    Generated at Fri Jan 26 11:43:00 GMT 2018
//|                                                          
...
extern string CustomComment = "Strategy 19.44";
...
int start() {
   ...
   if(manageTrades()) {
      ...
      // LONG: (((ATR(49) < ATR(34)) And (SMA(61) < EMA(70))) And (((EMA(36) < EMA(34)) And (EMA(36) > TEMA(70))) And (EMA(17) > EMA(70))))
      if(TradeLong) {
         bool LongEntryCondition = (((iATR(NULL, 0, 49, 1) < iATR(NULL, 0, 34, 1)) && (iMA(NULL, 0, 61, 0, MODE_SMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 70, 0, MODE_EMA, PRICE_CLOSE, 1))) && (((iMA(NULL, 0, 36, 0, MODE_EMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 34, 0, MODE_EMA, PRICE_CLOSE, 1)) && (iMA(NULL, 0, 36, 0, MODE_EMA, PRICE_CLOSE, 1) > iCustom(NULL,0, "TEMA", 70, 0, 1))) && (iMA(NULL, 0, 17, 0, MODE_EMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 70, 0, MODE_EMA, PRICE_CLOSE, 1))));
         if(LongEntryCondition == true) {
            openPosition(1);
         }
      }
   
      // SHORT: (((ATR(49) > ATR(34)) And (SMA(61) > EMA(70))) And (((EMA(36) > EMA(34)) And (EMA(36) < TEMA(70))) And (EMA(17) < EMA(70))))
      if(TradeShort) {
         bool ShortEntryCondition = (((iATR(NULL, 0, 49, 1) > iATR(NULL, 0, 34, 1)) && (iMA(NULL, 0, 61, 0, MODE_SMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 70, 0, MODE_EMA, PRICE_CLOSE, 1))) && (((iMA(NULL, 0, 36, 0, MODE_EMA, PRICE_CLOSE, 1) > iMA(NULL, 0, 34, 0, MODE_EMA, PRICE_CLOSE, 1)) && (iMA(NULL, 0, 36, 0, MODE_EMA, PRICE_CLOSE, 1) < iCustom(NULL,0, "TEMA", 70, 0, 1))) && (iMA(NULL, 0, 17, 0, MODE_EMA, PRICE_CLOSE, 1) < iMA(NULL, 0, 70, 0, MODE_EMA, PRICE_CLOSE, 1))));
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "Strategy 19.44", 9, "Tahoma", LabelColor);
